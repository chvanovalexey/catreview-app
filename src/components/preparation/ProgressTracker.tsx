...
export default function ProgressTracker() {
  ...
  return (
    <div className="w-full md:w-64 flex-shrink-0 border-r border-gray-200 bg-white p-4 flex flex-col">
      ...
      <div className="flex md:flex-col gap-2 overflow-x-auto md:overflow-visible pb-4 md:pb-0 flex-1">
        {PREPARATION_STEPS.map((config) => {
          ...
          return (
            <button
              ...
              className={`flex items-start gap-3 p-3 rounded-lg text-left transition-colors min-w-[200px] md:min-w-0 ${
                isActive
